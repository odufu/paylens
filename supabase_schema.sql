...
-- Seed default routes (Strict Routing: All Airtime and Data services -> ClubKonnect)
INSERT INTO public.vending_routes (service_type, network_provider, active_gateway, commission_rate)
VALUES 
  ('Airtime', 'MTN', 'ClubKonnect', 0.0300),
  ('Airtime', 'Airtel', 'ClubKonnect', 0.0300),
  ('Airtime', 'Glo', 'ClubKonnect', 0.0800),
  ('Airtime', '9mobile', 'ClubKonnect', 0.0700),
  ('Data', 'MTN', 'ClubKonnect', 0.0300),
  ('Data', 'Airtel', 'ClubKonnect', 0.0300),
  ('Data', 'Glo', 'ClubKonnect', 0.0450),
  ('Data', '9mobile', 'ClubKonnect', 0.0700),
