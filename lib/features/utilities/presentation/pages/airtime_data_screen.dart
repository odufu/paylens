...
class _AirtimeDataScreenState extends State<AirtimeDataScreen> {
  ...
  List<Map<String, dynamic>> _getFilteredPackages() {
    ...
    if (_selectedCategory == 'SME Data') {
      if (provider == 'mtn') {
        return [
          {'id': 'mtn-sme-1', 'name': 'MTN 1GB SME (30 Days)', 'amount': 250.0, 'variation': 'mtn-sme-1gb', 'duration': '30 Days'},
          {'id': 'mtn-sme-2', 'name': 'MTN 2GB SME (30 Days)', 'amount': 500.0, 'variation': 'mtn-sme-2gb', 'duration': '30 Days'},
          {'id': 'mtn-sme-5', 'name': 'MTN 5GB SME (30 Days)', 'amount': 1250.0, 'variation': 'mtn-sme-5gb', 'duration': '30 Days'},
          {'id': 'mtn-sme-10', 'name': 'MTN 10GB SME (30 Days)', 'amount': 2500.0, 'variation': 'mtn-sme-10gb', 'duration': '30 Days'},
          {'id': 'mtn-sme-25', 'name': 'MTN 25GB SME (30 Days)', 'amount': 10000.0, 'variation': 'mtn-25gb-sme-10000', 'duration': '30 Days'},
        ];
      } else if (provider == 'airtel') {
        return [
          {'id': 'art-sme-1', 'name': 'Airtel 1GB SME (30 Days)', 'amount': 260.0, 'variation': 'airtel-sme-1gb', 'duration': '30 Days'},
          {'id': 'art-sme-2', 'name': 'Airtel 2GB SME (30 Days)', 'amount': 520.0, 'variation': 'airtel-sme-2gb', 'duration': '30 Days'},
          {'id': 'art-sme-5', 'name': 'Airtel 5GB SME (30 Days)', 'amount': 1300.0, 'variation': 'airtel-sme-5gb', 'duration': '30 Days'},
        ];
      }
      return [
        {'id': '${provider}-sme-1', 'name': '$_selectedProvider 1GB SME', 'amount': 280.0, 'variation': '${provider}-sme-1gb', 'duration': '30 Days'},
        {'id': '${provider}-sme-2', 'name': '$_selectedProvider 2GB SME', 'amount': 560.0, 'variation': '${provider}-sme-2gb', 'duration': '30 Days'},
      ];
    }
    ...
    if (_selectedCategory == 'Daily/Weekly') {
      if (provider == 'mtn') {
        return [
          {'id': 'mtn-d-100', 'name': 'MTN 100MB (24 Hrs)', 'amount': 100.0, 'variation': 'mtn-10mb-100', 'duration': '24 Hrs'},
          {'id': 'mtn-d-200', 'name': 'MTN 200MB (2 Days)', 'amount': 200.0, 'variation': 'mtn-50mb-200', 'duration': '2 Days'},
          {'id': 'mtn-w-6gb', 'name': 'MTN 6GB (7 Days)', 'amount': 1500.0, 'variation': 'mtn-20hrs-1500', 'duration': '7 Days'},
        ];
      }
      return [
        {'id': '${provider}-d-100', 'name': '$_selectedProvider 100MB (24 Hrs)', 'amount': 100.0, 'variation': '${provider}-100mb-24h', 'duration': '24 Hrs'},
        {'id': '${provider}-w-1gb', 'name': '$_selectedProvider 1GB (7 Days)', 'amount': 500.0, 'variation': '${provider}-1gb-7d', 'duration': '7 Days'},
      ];
    }
    
    if (_selectedCategory == 'Corporate Gifting') {
      return [
        {'id': '${provider}-cg-1', 'name': '$_selectedProvider 1GB CG (30 Days)', 'amount': 230.0, 'variation': '${provider}-cg-1gb', 'duration': '30 Days'},
        {'id': '${provider}-cg-2', 'name': '$_selectedProvider 2GB CG (30 Days)', 'amount': 460.0, 'variation': '${provider}-cg-2gb', 'duration': '30 Days'},
        {'id': '${provider}-cg-5', 'name': '$_selectedProvider 5GB CG (30 Days)', 'amount': 1150.0, 'variation': '${provider}-cg-5gb', 'duration': '30 Days'},
      ];
    }
    ...
    if (provider == 'mtn') {
      return [
        {'id': 'mtn-m-1.5', 'name': 'MTN 1.5GB Monthly', 'amount': 1000.0, 'variation': 'mtn-100mb-1000', 'duration': '30 Days'},
        {'id': 'mtn-m-4.5', 'name': 'MTN 4.5GB Monthly', 'amount': 2000.0, 'variation': 'mtn-500mb-2000', 'duration': '30 Days'},
        {'id': 'mtn-m-6', 'name': 'MTN 6GB Monthly', 'amount': 2500.0, 'variation': 'mtn-3gb-2500', 'duration': '30 Days'},
        {'id': 'mtn-m-8', 'name': 'MTN 8GB Monthly', 'amount': 3000.0, 'variation': 'mtn-data-3000', 'duration': '30 Days'},
        {'id': 'mtn-m-10', 'name': 'MTN 10GB Monthly', 'amount': 3500.0, 'variation': 'mtn-1gb-3500', 'duration': '30 Days'},
        {'id': 'mtn-m-20', 'name': 'MTN 20GB Monthly', 'amount': 6000.0, 'variation': 'mtn-3gb-6000', 'duration': '30 Days'},
        {'id': 'mtn-m-40', 'name': 'MTN 40GB Monthly', 'amount': 10000.0, 'variation': 'mtn-40gb-10000', 'duration': '30 Days'},
      ];
    }
    
    return [
      {'id': '${provider}-m-1.5', 'name': '$_selectedProvider 1.5GB Monthly', 'amount': 1000.0, 'variation': '${provider}-1-5gb', 'duration': '30 Days'},
      {'id': '${provider}-m-3', 'name': '$_selectedProvider 3GB Monthly', 'amount': 1500.0, 'variation': '${provider}-3gb', 'duration': '30 Days'},
      {'id': '${provider}-m-10', 'name': '$_selectedProvider 10GB Monthly', 'amount': 3000.0, 'variation': '${provider}-10gb', 'duration': '30 Days'},
      {'id': '${provider}-m-20', 'name': '$_selectedProvider 20GB Monthly', 'amount': 5000.0, 'variation': '${provider}-20gb', 'duration': '30 Days'},
    ];
  }
  ...
  Future<void> _processPayment(WalletProvider walletProvider) async {
    ...
    BrandedLoadingOverlay.show(context, message: _isDataTab ? 'Processing data subscription...' : 'Processing airtime top-up...');
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: ActionChip(
                                ...
                                backgroundColor: provInfo['color'].withOpacity(0.12),
                                side: BorderSide(color: provInfo['color'].withOpacity(0.4)),
                                onPressed: () {
                                  setState(() {
                              ...
                              child: ChoiceChip(
                                label: Text(
                                  ...
                                  style: TextStyle(
                                    color: isSelected 
                                        ? AppColors.textDark 
                                        : (Theme.of(context).brightness == Brightness.dark ? Colors.white70 : AppColors.textGrey),
                                    fontWeight: FontWeight.bold,
                                    fontSize: 12,
                                  ),
                                ),
                                ...
                                side: BorderSide(
                                  color: isSelected 
                                      ...
                                      : (Theme.of(context).brightness == Brightness.dark ? Colors.white12 : AppColors.textLightGrey.withOpacity(0.5)),
                                ),
                                onSelected: (selected) {
                                  if (selected) {
                                    setState(() {
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final itemBgColor = isSelected 
                              ? (isDark ? AppColors.accentLime.withOpacity(0.08) : AppColors.primaryForest.withOpacity(0.06)) 
                              : Theme.of(context).cardColor;
                              
                          final itemBorderColor = isSelected 
                              ? (isDark ? AppColors.accentLime : AppColors.primaryForest) 
                              : (isDark ? Colors.white10 : Colors.grey.shade300);
                              
                          final itemTextColor = isSelected 
                              ? (isDark ? AppColors.accentLime : AppColors.primaryForest) 
                              : (isDark ? const Color(0xFFF0F4F2) : AppColors.textDark);
